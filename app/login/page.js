...
export default function Component() {
  ...
  if (session) {
    return <div className="flex justify-center items-center  flex-col">
      <h3 className="  text-green-600 font-bold text-lg" >Signed in as Github -</h3> {session.user.email} <br />
      <button className="flex items-center  border border-gray-700 rounded-lg mt-5 ml-8 shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
  ...
  return <>
    ...
    <button onClick={() => signIn()}
      className="flex items-center  border border-gray-700 rounded-lg mt-5 ml-8 shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
...
//                     <button
//                         type="submit"
//                         className="w-full py-2 bg-blue-500 text-white font-semibold rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
//                     >
